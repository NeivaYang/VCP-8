                        ...
                        <div class="col-md-12" id="cssPreloader">
                            <div class="form-row justify-content-start">
                                ...
                                <div class="form-group col-md-4 telo5ce">
                                    ...
                                    <input type="email" class="form-control telo5ce @error('email') is-invalid @enderror" id="email" name="email" >
                                    @error('email')
                ...
                if (email.length > 1) {
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data == true) {
                                $('#email').after('<div id="email-error" class="text-danger" <strong>Email already exist<strong></div>');
                            } else {
                                $('#email').after('<div id="email-error" class="text-success" <strong>Email is avaiable<strong></div>');
                            }
                        }
                    });    
                } else {
