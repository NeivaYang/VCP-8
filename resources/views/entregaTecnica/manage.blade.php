    ...
    <div class="container-fluid topo">
        ...
        <div class="row justify-content-end telo5inputfiltro mt-3">
            <div class="col-md-3 position">
                <form action="{{route('commissioning_filter')}}" method="POST" class="form form-inline">
                    @csrf
...
@section('conteudo')
                ...
                @foreach ($entrega_tecnica as $item)
                    <tr>
                        ...
                        <td class="acoes">
                            ...
                            @else
                                <a href="{{ route('edit_commissioning', $item->id ) }}" style="font-size: 20px;"><button type="button" class="botaoTabela"><i class="fa fa-pen"></i></button></a>
                            @endif
                            <a href="{{ route('datasheet_commissioning', $item->id ) }}" target="_blank" style="font-size: 20px"><button type="button" class="botaoTabela"><i class="far fa-file-pdf"></i></button></a>
    ...
    <div class="modal fade" id="createET" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="createETLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('save_commissioning') }}" id="formdados" method="POST">
                    @csrf
