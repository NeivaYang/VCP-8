...
@section('conteudo')
        ...
        <form action="{{ route('save_commissioning_aerial_part') }}" method="post" class="mt-3" id="formdados">
            @csrf
            <div id="alert">                
                ...
                <div class="tab-pane fade show active formcdc" id="cadastro" role="tabpanel" aria-labelledby="cadastro-tab">
                    <div class="col-md-12" id="cssPreloader">
                        ...
                        <div class="form-row justify-content-start">
                            ...
                            <div class="form-group col-md-3 telo5ce">
                                <label for="corrente">@lang('entregaTecnica.corrente_fusivel_painel')</label>
