...
@section('conteudo')
        ...
        <form action="{{ route('save_commissioning_pressure_connection') }}" method="post" class="mt-3" id="formdados">
            @csrf
            <div id="alert">                
                        ...
                        <div>
                            ...
                            <div class="form-row justify-content-start">
                                <div class="form-group col-md-3 telo5ce">
                                    ...
                                    <em class="input-unidade">@lang('unidadesAcoes.(m)')</em>
                                </div>
                                <div class="form-group col-md-3 telo5ce">
                                    ...
                                    <em class="input-unidade">@lang('unidadesAcoes.(pol)')</em>
                                </div>
                                <div class="form-group col-md-3 telo5ce">
