...
@section('conteudo')
        ...
        <form action="{{ route('save_commissioning_suction') }}" method="post" class="mt-3" id="formdados">
            @csrf
                    ...
                    <div class="col-md-12" id="cssPreloader"> 
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                <div class="card">
                                    <div class="card-body">
                                        <h3 class="card-title" id="titleCardImg" style="diplay:none"></h3>                                        
                                        <div class="text-center" id="myImg"><img src="{{ asset('img/image_none.png')}}" alt="none" class="img-fluid img-succao"><h2>@lang('entregaTecnica.sem_bomba_definida')</h2></div>
                            ...
                            <div class="col-md-3 telo5ce no-gutters">
                                ...
                                <div class="form-group col-md-12">
                                @if ($succao['medicao_succao_tipo'] != null)
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.6.1/js/bootstrap.min.js" integrity="sha512-UR25UO94eTnCVwjbXozyeVd6ZqpaAE9naiEUBK/A+QDbfSTQFhPGj5lOR6d8tsgbBk84Ggb5A3EkjsOgPRPcKA==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    ...
    <script>
        ...
        function imgSalvaBD() {
            ...
            switch (img_succao) {
                case 'direta':
                    $('#titleCardImg').html('@lang("entregaTecnica.direta")');
                    $('#direta').show();
                    break;
                case 'afogada':
                    $('#titleCardImg').html('@lang("entregaTecnica.afogada")');
                    $('#afogada').show();
                    break;
                case 'pocos':
                    $('#titleCardImg').html('@lang("entregaTecnica.pocos")');
                    $('#pocos').show();
                    break;
                case 'submersa': 
                    $('#titleCardImg').html('@lang("entregaTecnica.submersa")');
                    $('#submersa').show();
                    break;
                case  'balsa': 
                    $('#titleCardImg').html('@lang("entregaTecnica.balsa")');
                    $('#balsa').show();
                    break;
                default :
                    $('#titleCardImg').html('');
