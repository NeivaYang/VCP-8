    ...
    <div class="container-fluid topo">
        <div class="row align-items-start">
            ...
            <div class="col-6 text-right botoes mobile">
                ...
                <!-- modifica��o para bot�o salvar sair -->
                                    ...
                                    <tbody>
                                        ...
                                        @else
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control" id="comprimento_1" readonly><em class="input-tb-unidade">@lang('unidadesAcoes._m')</em></td>
                                                <td class="col-md-1">
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        function AddTableRow() {
            ...
            cols +='<td><input type="text" class="form-control" id="comprimento_' + rowCount + '" readonly><em class="input-tb-unidade">@lang('unidadesAcoes._m')</em></td>';
