                                ...
                                <tbody>
                                    @foreach ($adutoras as $adutora)                       
                                        <tr>
                                            ...
                                            <td class="col-md-2"><input type="number" class="form-control" step="0.01" min="0" required name="diametro[]" id="diametro_'{{ $adutora['id_adutora'] }}" value="{{ $adutora['diametro'] }}"><em class="input-tb-unidade">@lang('unidadesAcoes._mm')</em></td>
    ...
    <script>
        (function($) {
            AddTableRow = function() {
                ...
                cols += '   </select>';
                cols += '</td>';
                cols += '<td class="col-md-2"><input type="number" step="0.01" min="0" class="form-control" required name="diametro[]" id="diametro_' + rowCount + '"><em class="input-tb-unidade">@lang('unidadesAcoes._mm')</em></td>';
