...
@section('conteudo')
    ...
    <form action="{{ route('save_commissioning_tests') }}" method="post" class="mt-3" id="formdados" enctype="multipart/form-data">
        @csrf
                                        ...
                                        <tr>                                               
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    ...
                                                    <div>
                                                        @if ($item['tensao_rs_semcarga_img'] != null)
                                                            ...
                                                            <img src="{{ url('storage/'.$item['tensao_rs_semcarga_img'] ) }}"class="img_preview_editar" onclick="expandImage(this)" id="tensao_rs_semcarga_preview" data-imgval="{{ $item['tensao_rs_semcarga_img'] }}" />
                                                        @else                                                             
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    ...
                                                    <div>                                                            
                                                        @if ($item['tensao_st_semcarga_img'] != null)
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    ...
                                                    <div>                                                            
                                                        @if ($item['tensao_rt_semcarga_img'] != null)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    ...
                                                    <div>                                                           
                                                        @if ($item['tensao_rs_comcarga_img'] != null)
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div>                                                           
                                                            @if ($item['tensao_st_comcarga_img'] != null)
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    ...
                                                    <div>
                                                        @if ($item['tensao_rt_comcarga_img'] != null)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center">
                                                        ...
                                                        <div>
                                                        @if ($teste_bomba[0]['pressao_centro_img'] != null)
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center">
                                                        ...
                                                        <div>
                                                        @if ($teste_bomba[1]['pressao_ult_torre_img'] != null)
                    ...
                    <div class="form-row justify-content-start">                            
                        ...
                        <div class="form-group col-md-4 ">                                
                            <div class="d-flex justify-content-start">
                                ...
                                <div>
                                    @if ($velocidade['leitura_horímetro_img'] != null)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-center">
                                                            ...
                                                            <div>
                                                                @if ($item['pressao_reg_fechado_img'] != null)
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-center">
                                                            ...
                                                            <div>
                                                                @if ($item['pressao_reg_aberto_img'] != null)
                                    ...
                                    <tbody>
                                        @foreach ($total_chave_partida as $item)
                                            @if ($item['id_bomba'] == $bomba['id_bomba'])
                                                ...
                                                <tr>
                                                    <td class="align-middle">@lang('entregaTecnica.corrente_com_carga')</td>                   
                                                    <td>
                                                        <div class="d-flex justify-content-center">
                                                            <div class="campos_tensao col-10">
                                                                ...
                                                                <em class="input-ts-unidade">@lang('unidadesAcoes._A')</em>
                                                            ...
                                                            <div>
                                                                @if ($item['corrente_rs_comcarga_img'] != null)
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-center">
                                                            ...
                                                            <div>
                                                                @if ($item['corrente_st_comcarga_img'] != null)
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-center">
                                                            ...
                                                            <div>
                                                                @if ($item['corrente_rt_comcarga_img'] != null)
